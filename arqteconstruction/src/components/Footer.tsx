  ...
  return (
    <footer style={{
      ...
      >
        ...
        {/* Services */}
        <div>
          <h4 style={{ fontSize: "var(--text-xs)", fontWeight: 600, letterSpacing: "0.1em", textTransform: "uppercase", color: "var(--text-muted)", marginBottom: "var(--space-4)" }}>
            Services
          </h4>
          <ul style={{ listStyle: "none", display: "flex", flexDirection: "column", gap: "var(--space-2)" }}>
            {["New Construction", "Remodeling", "Exterior Envelope", "Windows & Doors", "Interior Glass"].map(s => (
              <li key={s}>
                <a href="#services" style={{ fontSize: "var(--text-sm)", color: "var(--text-faint)", transition: "color var(--transition)" }}
        ...
        <div>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "var(--space-3)" }}>
            <a href="tel:7863259406" style={{ display: "flex", alignItems: "center", gap: "var(--space-2)", fontSize: "var(--text-sm)", color: "var(--text-faint)", transition: "color var(--transition)" }}
            ...
            <a href="mailto:lorta@arqteconstruction.com" style={{ display: "flex", alignItems: "center", gap: "var(--space-2)", fontSize: "var(--text-sm)", color: "var(--text-faint)", transition: "color var(--transition)" }}
              onMouseEnter={e => (e.currentTarget.style.color = "var(--text)")}
              onMouseLeave={e => (e.currentTarget.style.color = "var(--text-faint)")}>
      ...
      <div style={{
        ...
        <p style={{ fontSize: "var(--text-xs)", color: "var(--text-faint)" }}>
          © {year} ArTeq Construction. All rights reserved.
        </p>
        <p style={{ fontSize: "var(--text-xs)", color: "var(--text-faint)" }}>
          Licensed General Contractor · Miami-Dade County
        </p>
      </div>
