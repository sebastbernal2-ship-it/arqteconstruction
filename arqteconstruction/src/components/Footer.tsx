    ...
    <footer style={{
      ...
      <div style={{ maxWidth: 'var(--content)', margin: '0 auto' }}>
        <div style={{
          ...
          <div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--space-3)' }}>
              <a href="tel:7863259406" style={{ display: 'flex', alignItems: 'center', gap: 'var(--space-2)', fontSize: 'var(--text-sm)', color: 'rgba(255,255,255,0.42)', transition: 'color var(--transition)' }}
              ...
              <a href="mailto:lorta@arqteconstruction.com" style={{ display: 'flex', alignItems: 'center', gap: 'var(--space-2)', fontSize: 'var(--text-sm)', color: 'rgba(255,255,255,0.42)', transition: 'color var(--transition)' }}
                onMouseEnter={e => e.currentTarget.style.color = 'rgba(255,255,255,0.80)'}
                onMouseLeave={e => e.currentTarget.style.color = 'rgba(255,255,255,0.42)'}>
          ...
          <div>
            ...
            <ul style={{ display: 'flex', flexDirection: 'column', gap: 'var(--space-3)' }}>
              {['New Construction', 'Remodeling', 'Exterior Envelope', 'Windows & Doors', 'Interior Glass', 'Maintenance'].map(s => (
                <li key={s}><a href="#services" style={{ fontSize: 'var(--text-sm)', color: 'rgba(255,255,255,0.36)', transition: 'color var(--transition)' }}
          ...
          <div>
            ...
            <ul style={{ display: 'flex', flexDirection: 'column', gap: 'var(--space-3)' }}>
              {[['About', '#about'], ['Services', '#services'], ['Get a Quote', '#contact']].map(([label, href]) => (
                <li key={href}><a href={href} style={{ fontSize: 'var(--text-sm)', color: 'rgba(255,255,255,0.36)', transition: 'color var(--transition)' }}
                  onMouseEnter={e => e.currentTarget.style.color = 'rgba(255,255,255,0.70)'}
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: 'var(--space-3)' }}>
          <p style={{ fontSize: 'var(--text-xs)', color: 'rgba(255,255,255,0.24)' }}>&copy; {year} ArTeq Construction LLC. All rights reserved.</p>
          <p style={{ fontSize: 'var(--text-xs)', color: 'rgba(255,255,255,0.24)' }}>Licensed General Contractor &middot; Miami-Dade County</p>
        </div>
      </div>
